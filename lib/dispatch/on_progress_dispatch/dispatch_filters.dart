...
class DispatchFilters extends StatelessWidget {
  const DispatchFilters({super.key});
                  ...
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () {
                      if (controller.fromDateController.text.isEmpty ||
                        ...
                        controller.searchbuttonnnnnnnnnnnnnnnn = true;
                      }
                    },
                  ),
                ),
              ),
              if (controller.searchbuttonnnnnnnnnnnnnnnn)
                const SizedBox(width: 10),
              if (controller.searchbuttonnnnnnnnnnnnnnnn)
                Padding(
                  padding: EdgeInsets.only(
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        await controller.Createexcel_Onprogress(context);
                      },
                      child: Text(
                        'Export',
                        style: TextStyle(color: Colors.white),
  ...
  Future<void> _selectDate(
    ...
    final otherController = controller ==
            Provider.of<OnProgressDispatchController>(context)
                .fromDateController
        ? Provider.of<OnProgressDispatchController>(context).endDateController
        : Provider.of<OnProgressDispatchController>(context).fromDateController;
