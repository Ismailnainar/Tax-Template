...
class LiveStaging_Quick_billWidgets {
  static Widget buildCardView(BuildContext context,
    ...
    return ListenableBuilder(
      ...
      builder: (context, child) {
        ...
        final visibleData = controller.QuickBill_filteredData.where((data) {
          final scanned =
                    ...
                    child: ConstrainedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          else if (controller.QuickBill_filteredData.isNotEmpty)
                            _buildTableBody(
  ...
  static Widget _buildTableBody(Map<int, double> columnWidths, bool isDesktop,
    ...
    return Expanded(
      child: SingleChildScrollView(
        ...
        child: Column(
          children: controller.QuickBill_filteredData.map((data) =>
              _buildTableRow(
                  data,
                  columnWidths,
                  isDesktop,
                  controller.QuickBill_filteredData.indexOf(data),
                  togglePage)).toList(),
        ),
      ),
    );
  ...
  static Widget _buildTableRow(
      ...
      int index,
      Function togglePage) {
    final balanceqty = int.tryParse(data['total_scan_count'].toString()) ?? 0;
    ...
    final total_scan_count = data['total_scan_count'];
    print("data in total_scan_count $data  ");
          ...
          children: [
            ...
            _buildTableCell(
              ...
              Row(
                ...
                children: [
                  Text(
                    data['truck_scan_count'].toString(),
                    style: TextStyle(
...
//         scrollDirection: Axis.vertical,
//         child: Column(
//           children: controller.QuickBill_filteredData
//               .map((data) => _buildTableRow(data, columnWidths, isDesktop,
//                   controller.QuickBill_filteredData.indexOf(data), togglePage))
//               .toList(),
//         ),
//       ),
//     );
