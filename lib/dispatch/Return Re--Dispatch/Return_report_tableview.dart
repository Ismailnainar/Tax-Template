...
class Return_ReportTable extends StatelessWidget {
  final Function togglePage;

  const Return_ReportTable({super.key, required this.togglePage});
        ...
        children: [
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          else if (controller.returnreasonfilteredData.isEmpty)
                            const Padding(
          ...
          Row(
            ...
            children: [
              ...
              if (!controller.isLoading &&
                  controller.returnreasonfilteredData.isNotEmpty)
  ...
  Widget _buildTableContent(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemCount: controller.returnreasonpaginatedData.length,
      itemBuilder: (context, index) {
        final data = controller.returnreasonpaginatedData[index];
        int serialNumber =
            (controller.reportcurrentPage - 1) * controller.reportitemsPerPage +
                index +
                1;
      ...
      child: Row(
        ...
        children: [
          IconButton(
            ...
            color: controller.reportcurrentPage > 1 ? Colors.blue : Colors.grey,
            onPressed: controller.reportcurrentPage > 1
                ? () => controller
                    .returnreasongoToPage(controller.reportcurrentPage - 1)
                : null,
          ),
          Container(
            padding: const EdgeInsets.symmetric(horizontal: 12),
            child: Text(
              'Page ${controller.reportcurrentPage} / ${controller.returnreasontotalPages}',
              style: const TextStyle(
                fontSize: 14,
                fontWeight: FontWeight.w500,
              ),
          ...
          IconButton(
            ...
            color:
                controller.reportcurrentPage < controller.returnreasontotalPages
                    ? Colors.blue
                    : Colors.grey,
            onPressed:
                controller.reportcurrentPage < controller.returnreasontotalPages
