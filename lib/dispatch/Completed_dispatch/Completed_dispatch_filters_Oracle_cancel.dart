...
class CompletedDispatchFilters_Oracle_cancel extends StatelessWidget {
  const CompletedDispatchFilters_Oracle_cancel({super.key});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          //             } else {
          //               controller.fetchDispatchOracle_cancelData();
          //             }
          //           },
          //         ),
          //       ),
          ...
          //             shadowColor: Colors.transparent,
          //           ),
          //           onPressed: controller.Oracle_CancelclearFilters,
          //           child: Text(
          //             'Clear',
          //             style: TextStyle(color: Colors.white),
          //           ),
              ...
              Row(
                children: [
                  ...
                  SizedBox(
                    ...
                    height: 33,
                    child: TextField(
                      controller: controller.OracleCancelsearchReqNoController,
                      ...
                      onChanged: (value) =>
                          controller.Oracle_Cancelsearchreqno(),
                      style: textBoxstyle,
                    ),
                  ),
                  if (controller.saveloginrole == 'WHR SuperUser') ...[
                    ...
                    SizedBox(
                      ...
                      child: TextField(
                        controller:
                            controller.Oracle_CancelsalesmanIdController,
                        decoration: const InputDecoration(
                        ...
                        style: textBoxstyle,
                        onChanged: (value) => controller.Oracle_Cancelsearch(),
                      ),
                    ),
                  ],
                ],
